"""
URL configuration for class_crud_proj project.
...
from crud_class_app.views import EmployeeCreate,EmployeeListView,EmployeeDetails,EmployeeUpdate,EmployeeDelete
